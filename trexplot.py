...
def plotting(faces,name,name2,surlabel,dim1,dim2,xlabel,ylabel,data,rotate):
    ...
    fig_contour = None
    axes_contour = None
    fig_vectors_no_cont = None
    axes_vectors_no_cont = None
    fig_vectors_cont = None
    axes_vectors_cont = None
...
def main():
    ...
    return flowfig, flowvecfig, dispfig, stress_strain_fig, aqconcfig, gas_volfrac_fig, min_ab_fig, min_si_fig
